/* Только после того, как я добрался до реализации пагинации, я понял,
   что нужно было начинать именно с нее... Тогда бы я изначально работал 
   с массивом, который как-будто пришел с бэка. Но зато так видно что я 
   умею работать и с html-данными ¯\_(ツ)_/¯ */ 
